...
export const THEMES = {
  stealth:     { light:false, name:"Stealth",     emoji:"🕶️", bg:"#0a0a0a", card:"#111111", cardAlt:"#1a1a1a", border:"#222222", borderAccent:"#2a2a2a", text:"#cccccc", textMuted:"#7c7c7c", textFaint:"#606060", accent:"#ffffff", surface:"#0f0f0f" },
  stealthLight:{ light:true,  name:"Stealth Light", emoji:"🕶️", bg:"#f5f5f5", card:"#eeeeee", cardAlt:"#e5e5e5", border:"#dddddd", borderAccent:"#d5d5d5", text:"#333333", textMuted:"#6a6a6a", textFaint:"#888888", accent:"#000000", surface:"#f0f0f0" },
} as const;
